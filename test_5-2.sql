...
--
-- Host: localhost
-- Erstellungszeit: 26. Aug 2019 um 16:32
...
--
-- Tabellenstruktur für Tabelle `accept_rules`
--

CREATE TABLE `accept_rules` (
  `ID` int(11) NOT NULL,
  `user` text NOT NULL,
  `rules_accepted` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `accept_rules`
--

INSERT INTO `accept_rules` (`ID`, `user`, `rules_accepted`) VALUES
(0, 'sdsfd', 'Ja');
